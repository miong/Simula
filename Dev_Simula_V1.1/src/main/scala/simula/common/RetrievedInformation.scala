 ...
 *
 */
class RetrievedInformation(val numberOfCitizen: Integer, val globalPolution: Integer, val globalCriminality: Integer, val viewable: Set[Viewable]) extends RetrievedInformationInterface {
